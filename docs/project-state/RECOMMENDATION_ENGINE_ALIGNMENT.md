...
> **Superseded by `FINAL_SCORING_SPEC.md` (ADR-0019).** That document is the sole source of truth
> for all scoring (factor/weight/confidence/risk/label/threshold/governance models). This file is
> retained only as reconciliation provenance — do not use it for engineering.
