...
const UI_COVERAGE: PageCoverage[] = [
  ...
  { page: 'Portfolio', route: '/mf/portfolio', total: 23, live: 6, pending: 'Health, goals, overlap, cost, AMC, timeline, projections, AI, report + 8 more (performance/cost backend live in P1a)' },
