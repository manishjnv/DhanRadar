...
_SOURCE_CATALOG: list[dict[str, str]] = [
    ...
    {
        "source_key": "amfi_cap_classification",
        "name": "AMFI Large/Mid/Small Cap Classification",
        "tier": "2",
        "description": "Half-yearly stock-level cap categorization (equity ISINs)",
        "method": "HTTP file download",
        "schedule_display": "Daily 04:15 IST (freshness check; skips if half already stored)",
        "cost": "Free",
        "celery_task": "dhanradar.tasks.mf.mf_cap_classification_fetch",
        "beat_key": "mf-cap-classification-fetch",
    },
    {
        "source_key": "amfi_category_flows",
        "name": "AMFI Category-wise Fund Flows",
        "tier": "2",
        "description": "Monthly mobilization/redemption/net-flow by SEBI scheme category",
        "method": "HTTP file download",
        "schedule_display": "Daily 04:45 IST (freshness check; skips if month already stored)",
        "cost": "Free",
        "celery_task": "dhanradar.tasks.mf.mf_category_flows_fetch",
        "beat_key": "mf-category-flows-fetch",
    },
    {
        "source_key": "mfapi",
        "name": "mfapi.in",
