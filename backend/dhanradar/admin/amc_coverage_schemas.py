...
class CoverageSummary(BaseModel):
    total_amcs: int
    total_funds: int
    nfo_count: int  # funds with launch_date >= as_of - 180 days
...
class CoverageMeta(BaseModel):
    ...
    nfo_definition: str = "Funds with a launch_date within the last 180 days."
    ...
    completeness_definition: str = (
        ...
        "AMC's funds with a non-null value for the field. Overall: the fund-count-"
        "weighted average of every AMC's completeness_pct."
    )
