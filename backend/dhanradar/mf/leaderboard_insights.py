...
_SYSTEM_PROMPT = (
    ...
    "Units — quote every number EXACTLY as given, never re-scale it: fields ending "
    "in _cr are amounts already denominated in ₹ crore (net_flow_cr of 5697.9 "
    "means ₹5,697.9 crore, NOT 5.7 crore); fields ending in _pct are "
    "percentages; rank_delta is the number of places moved in the ranking. "
    "Write label values in plain words (off_track -> 'Off Track', in_form -> "
    "'In Form') without changing their meaning. "
