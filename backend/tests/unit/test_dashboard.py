...
tests/integration/test_dashboard.py). Covers the DB-free seams:
  ...
  * ticker  — Yahoo mocked: happy path, cold flows cache, last-known-good fallback.

Portfolio-summary/top-scored ranking + schema tests were removed with the
decommissioned /dashboard page (folded into /mf/portfolio).
